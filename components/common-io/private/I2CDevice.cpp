...
void esc::I2CDevice::initialize()
{
	...
	// We set an extremely high timeout because devices like BNO055 use
	// time stretching and would otherwise timeout constantly.
...
void esc::I2CDevice::write(gsl::span<const uint8_t> data) const
{
	...
	i2c_master_stop(cmd);
	i2c_master_cmd_begin(I2C_PORT, cmd, 1);
